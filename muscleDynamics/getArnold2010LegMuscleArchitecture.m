...
arnold2010LegMuscleArchitectureFiles = { ...
        'arnold2010LegMuscleArchitectureAbbreviation.txt',       ... % 各肌肉缩写
        'arnold2010LegMuscleArchitectureNames.txt',              ... % 各肌肉全称
        'arnold2010LegMuscleArchitectureOptimalFiberLength.txt', ... % 各肌肉最优肌肉长度，cm
        'arnold2010LegMuscleArchitecturePCSA.txt',               ... % 各肌肉的PCSA（physiological cross sectional area生理横截面积），cm2
        'arnold2010LegMuscleArchitecturePeakForce.txt',          ... % 各肌肉最大力度，N
        'arnold2010LegMuscleArchitecturePennationAngle.txt',     ... % 各肌肉羽状角，°
        'arnold2010LegMuscleArchitectureTendonSlackLength.txt' };    % 各肌肉松弛时肌腱长度，cm


typeString = 1; % 类型为string
typeNumber = 0; % 类型为number
