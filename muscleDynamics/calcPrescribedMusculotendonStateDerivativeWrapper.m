...
function dState = calcPrescribedMusculotendonStateDerivativeWrapper(t,...
                                                                    muscleIdx,...
                                                                    state,...
                                                                    pathFcn,...
                                                                    excFcn,...
...
pathState       = pathFcn(t, muscleIdx, muscleStateRecord);
excitation      = excFcn(muscleIdx, record, skeletonPose);
activation      = actFcn(t, muscleIdx, excitation, record);

mtInfo = calcMuscleInfoFcn(activation,...
                           pathState,...
                           state);      

dState = mtInfo.state.derivative; % 肌肉沿肌腱方向的变化速度