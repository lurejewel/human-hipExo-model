...
%    135(2), 021005.
%%
function dactivation = calcFirstOrderActivationDerivative(~, excitation, activation)

activationTimeConstant   = 10/1000; % 0.01
deActivationTimeConstant = 40/1000; % 0.04
minimumActivation        = 0.01;

u = clampWithinInterval(excitation, minimumActivation, 1); % clamped excitation
a = clampWithinInterval(activation, minimumActivation, 1); % clamped activation
tau = NaN;
