...
%% Check inputs
rootEPS = eps^0.5;
assert( (x0>=0 && x1>x0+rootEPS  && x2>x1+rootEPS && x3>x2+rootEPS),... % 这个写法真的牛逼    
...
c = scaleCurviness(curviness); % 将[0, 1]映射到[0.1, 0.9]
